...
const Notifications = () => {
  ...
  const toggleSuccessNotify = () => {
    toast.success('Success Notification !', {
      position: positionNotify,
    });
  };
  const toggleErrorNotify = () => {
    toast.error('Error Notification !', {
      position: positionNotify,
    });
  };
  const toggleInfoNotify = () => {
    toast.info('Info Notification !', {
      position: positionNotify,
    });
  };
  const onChangePosition = (place) => {
    setPositionNotify(place);
  };
  ...
  return (
    <>
      ...
      <section style={{ display: closedBlock ? 'none' : '' }} className='notifications-block'>
                ...
                <div className='notifications-block__column'>
                  ...
                  <div className='notifications-block__selector'>
                    <div className='location-selector'>
                      <div
                        onClick={() => onChangePosition('top-left')}
                        className='bit top left'></div>
                      <div
                        onClick={() => onChangePosition('top-right')}
                        className='bit top right'></div>
                      <div onClick={() => onChangePosition('top-center')} className='bit top'></div>
                      <div
                        onClick={() => onChangePosition('bottom-left')}
                        className='bit bottom left'></div>
                      <div
                        onClick={() => onChangePosition('bottom-right')}
                        className='bit bottom right'></div>
                      <div
                        onClick={() => onChangePosition('bottom-center')}
                        className='bit bottom'></div>
                    </div>
                  </div>
                </div>
                <div className='notifications-block__column'>
                  ...
                  <div className='notifications-block__buttons'>
                    <div className='notifications-block__info-button'>
                      <button onClick={toggleInfoNotify} className='btn btn-primary'>
                        Info Message
                      </button>
                    </div>
                    <div className='notifications-block__error-button'>
                      <button onClick={toggleErrorNotify} className='btn btn-danger'>
                        Error + Retry Message
                      </button>
                    </div>
                    <div className='notifications-block__success-button'>
                      <button onClick={toggleSuccessNotify} className='btn btn-success'>
                        Success Message
                      </button>
                      <ToastContainer />
                    </div>
