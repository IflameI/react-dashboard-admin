    ...
    <aside className='sidebar'>
      ...
      <div className='sidebar__nav'>
        ...
        <ul className='sidebar__middle'>
          <li className='sidebar__link'>
            <a className='sidebar__dec sidebar__dec-green' href='#'>
              My Recent
            </a>
          </li>
          <li className='sidebar__link'>
            <a className='sidebar__dec sidebar__dec-blue' href='#'>
              Starred
            </a>
          </li>
          <li className='sidebar__link'>
            <a className='sidebar__dec sidebar__dec-red' href='#'>
              Background
            </a>
          </li>
        </ul>
        ...
        <div className='sidebar__bars bars-sidebar'>
          <div className='bars-sidebar__item'>
            <div className='bars-sidebar__head'>
              ...
              <div className='bars-sidebar__close'>
                <button>x</button>
              </div>
            </div>
