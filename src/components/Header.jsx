      ...
      <div className='header__row'>
        ...
        <div className='header__alert'>
          <div className='header__alert-content' style={{ display: closedBlock ? 'none' : '' }}>
            ...
            <button className='btn-setting' onClick={toggleVisibleSettings}>
              <svg
            ...
            on the right
            <button className='btn-close' onClick={toggleClosedBlock}>
              x
            </button>
          </div>
        </div>
        <div className='header__profile' ref={menuRef}>
          <div className='header__info'>
            <div className='header__sub-wrapper' onClick={toggleVisibleInfo}>
              ...
              <div className='header__notifications notifications-header'>
                <div className='notifications-header__wrapper'>
                  ...
                  <div className='notifications-header__date'>
                    <span className='notifications-header__number'>
                      Synced at: 21 Feb 2021 18:36
                    </span>
          ...
          <div className='header__functionals'>
            <div className='header__messages' onClick={toggleVisibleMessages}>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='100%'
                height='100%'
            ...
            <div className='header__settings' onClick={toggleVisibleSettings}>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='100%'
                height='100%'
            ...
            <div className='header__tickets' onClick={toggleVisibleTickets}>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='100%'
                height='100%'
